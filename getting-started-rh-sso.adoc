...
----
cd $CHE_PROJECTS_ROOT/cloud-native-workshop-v2m5-labs && git checkout ocp-4.7
----
...
The project displayed on the landing page depends on which labs you will run today.
