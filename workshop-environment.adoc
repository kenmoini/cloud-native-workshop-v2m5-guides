...
* https://cloud.redhat.com/learn/topics/serverless[Red Hat Service Mesh^] - an Istio-based Service Mesh that supports multi-tenancy and other enterprise-grade functions
