...
1. In the left-hand pane, navigate to *Clients* and then click *Create* to the right

image::rhsso_create_client_button.png[sso, 1100]

2. Give it a Client ID of `pet-id` - click *Save*

image::rhsso_create_client_pet-id.png[sso, 1100]

3. Configure the Client Settings with the following:
...
2. Give it a Client ID of `furever-home` - click *Save*
