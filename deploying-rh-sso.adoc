...
With the user created, click the *Credentials* tab and set the password for the user to - set it to something like `password`.  Make sure to set *Temporary* to Off!
